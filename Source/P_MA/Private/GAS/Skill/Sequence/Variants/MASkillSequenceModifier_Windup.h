...
#include "MASkillSequenceModifier_Windup.generated.h"

UCLASS(BlueprintType, EditInlineNew, DefaultToInstanced)
class P_MA_API UMASkillSequenceModifier_Windup : public UMASkillSequenceModifier
{
	GENERATED_BODY()

public:
	UMASkillSequenceModifier_Windup();
	void Configure(float InDuration);
